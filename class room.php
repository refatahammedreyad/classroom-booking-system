  ...
  <nav>
    ...
    <div class="class-image">
      <div class="class-content">
        <img src="image/classroom1.jpg" class="cl-img" />
        <h1>Class Room 1</h1>
        <p>
      ...
      <div class="class-content">
        <img src="image/classroom2.jpg" class="cl-img" />
        <h1>Class Room 2</h1>
        <p>
      ...
      <div class="class-content">
        <img src="image/classroom3.jpg" class="cl-img" />
        <h1>Class Room 3</h1>
        <p>
            Student Capacity: 40 Person.
        </p>
      ...
      <div class="class-content">
        <img src="image/lab1.jpg" class="cl-img" />
        <h1>Class Room 4</h1>
        <p>
            Student Capacity: 40 Person.
        </p>
